    ...
    container.innerHTML = products.map(product => `
        <div class="card" data-id="${product.id}">
            ...
            <div class="card__content">
                ...
                <div class="card__price">${product.price} руб / 250г</div>
...
function openEditModal(id) {
    ...
    if (product) {
        ...
        if (modalTitle) modalTitle.textContent = 'Редактировать кофе';
...
function openAddModal() {
    ...
    if (modalTitle) modalTitle.textContent = 'Добавить кофе';
